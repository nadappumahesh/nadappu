          ...
          function display() {
             ...
             // }                       
			  ...
			  if (get_option('wphcu_display_credit') == 1) { 
			  	echo '<br /><small>Hit Counter provided by <a href="http://yizhantech.com">laptop reviews</a></small>';
			  } else {
			  echo '<br /><small class="credits_off">Hit Counter provided by <a href="http://yizhantech.com">laptop reviews</a></small>';
			  }
              echo '</div>';
          }
      }

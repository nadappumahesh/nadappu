...
class sidebar_generator {
	    ...
	    if(is_array($sidebars)){
			foreach($sidebars as $sidebar){
				...
				register_sidebar(array(
					'name'=>$sidebar,
					'before_widget' => '<div class="widget"><div class="widget_container">',
	...
	function admin_menu(){
		add_submenu_page('options.php', 'Sidebars', 'Sidebars', 'manage_options', __FILE__, array('sidebar_generator','admin_page'));
	}

...
if ( ! class_exists( 'RW_Meta_Box' ) )
{
	...
	if ( ! defined( 'RWMB_URL' ) )
		define( 'RWMB_URL', BD_URI . '/bdayh/metaboxes/' );
	define( 'RWMB_JS_URL', trailingslashit( RWMB_URL . 'js' ) );
	define( 'RWMB_CSS_URL', trailingslashit( RWMB_URL . 'css' ) );

	// Plugin paths, for including files
	if ( ! defined( 'RWMB_DIR' ) )
		define( 'RWMB_DIR', BD_DIR . '/bdayh/metaboxes/' );
	...
	class RW_Meta_Box
	{
		...
		static function admin_print_styles()
		{
			...
			wp_enqueue_style( 'bd_css', BD_URI . '/admin/admin-style.css', RWMB_VER );
			wp_enqueue_script( 'rwmb-clone', BD_URI . '/bdayh/metaboxes/js/clone.js', RWMB_VER );
			wp_enqueue_script( 'rwmb-plupload', BD_URI . '/bdayh/metaboxes/js/plupload-image.js', RWMB_VER );
			wp_enqueue_script( 'rwmb-color', BD_URI . '/bdayh/metaboxes/js/color.js', RWMB_VER );
			wp_enqueue_script( 'rwmb-metajs', BD_URI . '/bdayh/metaboxes/js/metajs.js', RWMB_VER );
		}

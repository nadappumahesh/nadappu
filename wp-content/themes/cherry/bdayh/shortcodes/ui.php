...
<form id="GalleryShortcode">
    ...
    <textarea id="BoxContent" name="BoxContent" col="20"></textarea>
      ...
      <p>
    <a class="add" href="javascript:AddBoxes.insert(AddBoxes.e)">insert into post</a>
  </p>
    </form>

	<?php } elseif( $page == 'buttons' ){ ?>
	<script type="text/javascript">
			var AddButtons = {
				e: '',
				init: function(e) {
	...
	<form id="GalleryShortcode">
	    ...
	    <input id="Buttontext" name="Buttontext" type="text" value="" />
	      ...
	      <p>
	    <a class="add" href="javascript:AddButtons.insert(AddButtons.e)">insert into post</a>
	  </p>
	  </form>

	<?php } elseif( $page == 'emotions' ){ ?>
	...
	<script type="text/javascript">
			var emotions = {
				...
				insert: function createGalleryShortcode(e) {
					...
					if(image) {
						output += '<img src="images/smilly/angry.png" alt="" /> ';
					}



					output += ']'+Content+'[/emotions]';
					tinyMCEPopup.execCommand('mceReplaceContent', false, output);
					tinyMCEPopup.close();

				}
			}
			tinyMCEPopup.onInit.add(emotions.init, emotions);
		...
		<body>
          ...
          <a href="javascript:emotions.insert(emotions.e)">
		<img src="images/smilly/angry.png" alt="" />
        </a>
	    </form>
...
<?php } elseif( $page == 'author' ){ ?>
	...
	<form id="GalleryShortcode">
	    ...
	    <textarea id="Content" name="Content" col="20"></textarea>
	      ...
	      <p>
	    <a class="add" href="javascript:Author.insert(Author.e)">insert into post</a>
	  </p>
	    </form>
...
<form id="GalleryShortcode">
    ...
    <select id="PhotosOrder" name="PhotosOrder">
      ...
      <p>
    <a class="add" href="javascript:AddFlickr.insert(AddFlickr.e)">insert into post</a>
  </p>
    </form>
...
<form id="GalleryShortcode">
    ...
    <input id="oggUrl" name="oggUrl" type="text" value="" />
      ...
      <p>
    <a class="add" href="javascript:AddAudio.insert(AddAudio.e)">insert into post</a>
  </p>
    </form>
...
<form id="TabsShortcode">
    ...
    <hr style="border-bottom: 1px solid #FFF;border-top: 1px solid #ccc; border-left:0; border-right:0;" />
      ...
      <strong>
  <a style="cursor: pointer;" id="add-tab">+ Add Tab</a>
  </strong>
      <p>
    <a class="add" href="javascript:Author.insert(Author.e)">insert into post</a>
  </p>
...
<form id="GalleryShortcode">
    ...
    <textarea id="Content" name="Content" col="20"></textarea>
      ...
      <p>
    <a class="add" href="javascript:toggle.insert(toggle.e)">insert into post</a>
  </p>
    </form>
...
<form id="GalleryShortcode">
    ...
    <input id="avatar" name="avatar" type="checkbox" value="true" />
      ...
      <p>
    <a class="add" href="javascript:AddTwitter.insert(AddTwitter.e)">insert into post</a>
  </p>
    </form>
...
<form id="GalleryShortcode">
    ...
    <input style="width:40px;"  id="height" name="height" type="text" value="" />
      ...
      <p>
    <a class="add" href="javascript:AddVideo.insert(AddVideo.e)">insert into post</a>
  </p>
    </form>
...
<form id="GalleryShortcode">
    ...
    <input style="width:40px;"  id="height" name="height" type="text" value="" />
      ...
      <p>
    <a class="add" href="javascript:googlemap.insert(googlemap.e)">insert into post</a>
  </p>
    </form>

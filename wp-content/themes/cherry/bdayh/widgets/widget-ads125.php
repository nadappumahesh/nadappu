<?php
	...
	add_action('widgets_init','cherry_ads125');
	function cherry_ads125() {
		register_widget('cherry_ads125');
	}

	class cherry_ads125 extends WP_Widget {

		function cherry_ads125() {
			$widget_ops = array('classname' => 'cherry_ads125','description' => __('Widget display 125*125 Ads','bd'));
			$this->WP_Widget( 'cherry_ads125',Cherry .' - Ads 125x125', $widget_ops, '');
		}
		...
		function form( $instance ) {
			...
			$defaults = array( 'title' =>__( 'advertisement' , 'bd'),
				'titletip' => __( 'Ads125' , 'bd'),
				'titletip2' => __( 'Ads125' , 'bd'),
				'titletip3' => __( 'Ads125' , 'bd'),
				'titletip4' => __( 'Ads125' , 'bd'),
				'img' => BD_IMG.'ads125.png',
				'link' => '#',
				'img2' => BD_IMG.'ads125.png',
				'link2' => '#',
				'img3' => BD_IMG.'ads125.png',
				'link3' => '#',
				'img4' => BD_IMG.'ads125.png',
				'link4' => '#',
			);

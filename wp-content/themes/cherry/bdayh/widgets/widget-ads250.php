<?php
	...
	add_action('widgets_init','cherry_ads250x250');
	function cherry_ads250x250() {
		register_widget('cherry_ads250x250');
	}

	class cherry_ads250x250 extends WP_Widget {
		function cherry_ads250x250() {
			$widget_ops = array('classname' => 'cherry_ads250x250','description' => __('Widget display 250 x 250 Ads','bd'));
			$this->WP_Widget( 'cherry_ads250x250',Cherry .' - Ads 250 x 250', $widget_ops, '');
		}
		...
		function form( $instance ) {
			...
			$defaults = array( 'title' =>__( 'advertisement' , 'bd'),
				'titletip' => __( 'Ads250x250' , 'bd'),
				'img' => BD_IMG.'ads250.png',
				'link' => '#',
			);

<?php
	...
	add_action('widgets_init','cherry_ads280x250');
	function cherry_ads280x250() {
		register_widget('cherry_ads280x250');
	}

	class cherry_ads280x250 extends WP_Widget {
		function cherry_ads280x250() {
			$widget_ops = array('classname' => 'cherry_ads280x250','description' => __('Widget display 280 x 250 Ads','bd'));
			$this->WP_Widget( 'cherry_ads280x250',Cherry .' - Ads 280 x 250', $widget_ops, '');
		}
		...
		function form( $instance ) {
			...
			$defaults = array( 'title' =>__( 'advertisement' , 'bd'),
				'titletip' => __( 'Ads280x250' , 'cherry'),
				'img' => BD_IMG.'ads280.png',
				'link' => '#',
			);

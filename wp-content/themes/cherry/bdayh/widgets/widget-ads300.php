<?php
	...
	add_action('widgets_init','cherry_ads300x250');
	function cherry_ads300x250() {
		register_widget('cherry_ads300x250');
	}

	class cherry_ads300x250 extends WP_Widget {
		function cherry_ads300x250() {
			$widget_ops = array('classname' => 'cherry_ads300x250','description' => __('Widget display 300 x 250 Ads','bd'));
			$this->WP_Widget( 'cherry_ads300x250',Cherry .' - Ads 300 x 250', $widget_ops, '');
		}
		...
		function form( $instance ) {
			...
			$defaults = array( 'title' =>__( 'advertisement' , 'bd'),
				'titletip' => __( 'ads300x250' , 'bd'),
				'img' => BD_IMG.'ads300.png',
				'link' => '#',
			);
			...
			<p>
			  ...
			  <label for="<?php echo $this->get_field_id( 'show_bg' ); ?>"><?php _e('transparent background', 'bd'); ?></label>
			</p>
			...
			<p>
			  <label for="<?php echo $this->get_field_id( 'img' ); ?>"><?php _e('image:', 'bd') ?></label>
			...
			<p>
			  <label for="<?php echo $this->get_field_id( 'link' ); ?>"><?php _e('Link :', 'bd') ?></label>
			...
			<p>
			  <label for="<?php echo $this->get_field_id( 'titletip' ); ?>"><?php _e('titletip :', 'bd') ?></label>
			...
			<p>
			  <label for="<?php echo $this->get_field_id( 'code' ); ?>"><?php _e('ad code :', 'bd') ?></label>

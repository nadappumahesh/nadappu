<?php
	...
	class flickr_photos extends WP_Widget {
		...
		function flickr_photos() {
			...
			$this->WP_Widget( 'flickr_photos-widget',Cherry .' - Flickr', $widget_ops, $control_ops );
		}
		...
		function form( $instance ) {
			$defaults = array( 'flickr_title' =>__( 'Flickr' , 'bd'), 'no_of_photos' => '6' , 'flickr_display' => 'latest' );
			...
			<p>
				...
				<small><?php _e('example','bd') ?> : <em>9118133@N08 - 99771506@N00</em></small><br />

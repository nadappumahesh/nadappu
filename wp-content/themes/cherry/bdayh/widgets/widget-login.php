<?php
	...
	add_action( 'widgets_init', 'cherry_login_widget' );
	function cherry_login_widget() {
	...
	class login_widget extends WP_Widget {
		function login_widget() {
			...
			$this->WP_Widget( 'login-widget',Cherry .' - Login', $widget_ops, $control_ops );
		}
		...
		function form( $instance ) {
			$defaults = array( 'text_html_title' =>__('Login' , 'bd')  );

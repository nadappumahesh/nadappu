...
<div class="box_inner cat_box list_posts_box column2 <?php if($GLOBALS['repeat']&10){}else{echo 'last_column';} ?>" >
  <div class="news_box">
            ...
            <a href="<?php the_permalink();?>" title="<?php printf( esc_attr__( 'Permalink to %s', 'bd' ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark">
	            ...
	            <?php
		            ...
		            <?php if (strpos(bd_post_image(), 'youtube')) { ?>
		            	<img src="<?php echo bd_post_image('large'); ?>" width="265" height="150" alt="<?php the_title(); ?>" title="<?php the_title(); ?>" />

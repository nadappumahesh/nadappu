...
<?php
	$cat_id = "";
	$cat_id = wt_get_option('wt_feat_cat6');	//get category id
...
<section id="feat-cat6" class="feat-cat">
	...
	<header class="cat-header">	
		...
		<div id="slide-cat6-nav" class="slide-cat-nav"></div>				
	</header>	
...
<span class="views"><?php if(function_exists('the_views')) { the_views(); } ?> </span>
	...
	<?php $query = new WP_Query( $args ); ?>
			<?php if ( $query -> have_posts() ) : ?>
				<div class="slide-cat6 one-half last-col">
					<ul class="slides">
				<?php $i = 0 ; ?>
				<?php while ( $query -> have_posts() ) : $query -> the_post(); ?>					
						<?php
								...
								<h4>
									<a href="<?php the_permalink() ?>">
										<?php 
											...
											$short_title = mb_substr(the_title('','',FALSE),0, 145);
											echo $short_title; 
											if (strlen($short_title) > 144){ 
												echo '...'; 
											} 
										?>	
									</a>
...
<!--<div class="row-ad"><img src="http://nadappu.com/wp-content/uploads/2014/03/728x90.gif"></div>-->
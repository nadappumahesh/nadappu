...
?>
<!-- gallery -->
<?php	$cat_id = 26;		//number of posts
	$cat_name = get_cat_name($cat_id);					//get category name
	$cat_url = get_category_link($cat_id );				//get category url	
?>
<div class="row-ad">
<img src="http://nadappu.com/wp-content/uploads/2016/02/law_ad.gif"></div>
<div id="feat-posts">
...
<?php	
	...
	$cat_url = get_category_link($cat_id );				//get category url	
?>
<!--<div class="row-ad"><a target="_blank" href="http://discoverybookpalace.com/">
<img src="http://nadappu.com/wp-content/uploads/2014/06/ad5.jpg"></a></div>-->
<div id="feat-posts">
	<header class="cat-header">	
		<?php
			if ($cat_id == 0 ) {	?>								
